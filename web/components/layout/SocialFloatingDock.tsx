      ...
      {active.map((item) => (
        <Link
          ...
          className={cn(
            ...
            'border border-border/80 bg-background/85 text-muted-foreground backdrop-blur-md',
            'shadow-sm transition-all duration-200',
            'hover:border-primary/45 hover:bg-surface hover:text-primary hover:shadow-md',
